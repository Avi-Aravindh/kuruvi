...
I'm here to help coordinate the team and ensure tasks get to the right agent!`;
  ...
  /**
   * Helix runs more frequently to stay responsive
   * Override the base run method to check every 5 minutes instead of 15
   */
  async run(): Promise<void> {
    console.log(`[${this.config.name}] 🔄 Coordinator check...`);
    await super.run();
  }
}
